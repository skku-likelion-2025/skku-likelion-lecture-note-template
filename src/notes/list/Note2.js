    ...
    return <div className={style.container}>
        ...
        <div className={style.section}>
            <input
                ...
                />
            <button className={style.button} onClick={handlePostlog}>
                유저 정보 GET
            </button>
        ...
        <hr/>
        <div className={style.section}>
            <input className={style.input} type="text" value={게시글제목}
            onChange={(e) =>{게시글제목변경(e.target.value)}}
            placeholder="게시글 제목"
            />
            <textarea className={style.textarea} 
            value={게시글내용}
            onChange={(e) =>{게시글내용변경(e.target.value)}}placeholder="게시글 내용" rows="4"/>
            <button className={style.button} onClick={handlePostlog}>
                게시글 작성하기 POST
            </button>
        </div>
